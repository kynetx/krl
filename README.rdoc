...
=== Optional Growl Functionality
To get the optional growl notify functionality, you will need to have the growl gem for ruby installed. If you do not, enter this at the command prompt:
