...
=== OS X
Ruby is installed by default on Leopard and Snow Leopard (10.5, 10.6).  You will, however, need to install the XCode in order to use the KRL gem. They can be found on your OS X install DVDs or from here: http://developer.apple.com/technologies/xcode.html
